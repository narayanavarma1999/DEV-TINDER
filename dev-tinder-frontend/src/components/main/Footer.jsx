      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary">Webinars</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-primary">Dev<span className="text-primary-light">Tinder</span></span>
            <span className="ml-4 text-gray-500 text-sm">© {new Date().getFullYear()} DevTinder. All rights reserved.</span>
          </div>
